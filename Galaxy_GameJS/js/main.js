...
function Pool(maxSize) {
	var size = maxSize; // Max bullets allowed in the pool cota de maximo superior
	var pool = [];
	...
	/*
	 * Populates the pool array with the given object creea tantas balas como me ha dicho el init
	 */
...
function Enemy() {
	 ...
	 */
	this.fire = function() {
		game.enemyBulletPool.get(this.x+this.width/3, this.y+this.height, -2.5);
	};
